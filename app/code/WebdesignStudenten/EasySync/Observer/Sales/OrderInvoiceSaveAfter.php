...
class OrderInvoiceSaveAfter implements \Magento\Framework\Event\ObserverInterface
{
 ...
 public function execute(\Magento\Framework\Event\Observer $observer) {
      ...
      $orderInvoiceId = $observer->getEvent()->getInvoice()->getData('entity_id');
      $easySyncCollectionFactory = $this->easySyncCollectionFactory->create()->getCollection()
          ->addFieldToFilter('dataScope', 'invoice')
          ->addFieldToFilter('dataID', array('eq' => $orderInvoiceId))
          ->getFirstItem();
