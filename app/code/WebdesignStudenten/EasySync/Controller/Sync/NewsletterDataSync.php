...
namespace WebdesignStudenten\EasySync\Controller\Sync;

class NewsletterDataSync extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($sXML->item as $oEntry) {
            ...
            $this->newsletterFactory->subscribe($newsletterDataArray['subscriber_email']);
