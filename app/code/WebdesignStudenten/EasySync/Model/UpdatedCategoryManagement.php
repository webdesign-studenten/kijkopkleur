...
class UpdatedCategoryManagement implements \WebdesignStudenten\EasySync\Api\UpdatedCategoryManagementInterface
{
    /**
    ...
    {
        $updatedCustomerModel = $this->_dataFactory->create()->getCollection()->addFieldToFilter('dataScope', 'category')->addFieldToFilter('UpdateFlag', '1');
     ...
     * @inheritdoc
     */
    public function setUpdatedCategoryFlag($syncId)
    {
