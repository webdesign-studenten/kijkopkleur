...
class UpdatedQuoteManagement implements \WebdesignStudenten\EasySync\Api\UpdatedQuoteManagementInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function getUpdatedQuotes()
    {
        $updatedProductModel = $this->_dataFactory->create()->getCollection()->addFieldToFilter('dataScope', 'quote')->addFieldToFilter('UpdateFlag', '1');
     ...
     * @inheritdoc
     */
    public function setUpdatedQuoteFlag($syncId)
    {
