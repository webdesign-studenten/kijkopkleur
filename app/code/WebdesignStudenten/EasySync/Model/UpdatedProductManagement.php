...
class UpdatedProductManagement implements \WebdesignStudenten\EasySync\Api\UpdatedProductManagementInterface
{
    /**
    ...
    {
        $updatedProductModel = $this->_dataFactory->create()->getCollection()->addFieldToFilter('dataScope', 'product')->addFieldToFilter('UpdateFlag', '1');
     ...
     * @inheritdoc
     */
    public function setUpdatedProductFlag($syncId)
    {
