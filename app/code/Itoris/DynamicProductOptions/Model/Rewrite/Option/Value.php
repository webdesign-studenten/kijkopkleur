...
class Value extends \Magento\Catalog\Model\Product\Option\Value
{
    ...
    public function getDpoConfig() {//return null;
        if (!$this->dpoConfig) {
    ...
    public function getDpoProduct() {
        ...
        if (!$this->dpoProduct && $this->dpoConfig) {
            ...
            if (!$this->dpoProduct) {
                ...
                $this->dpoProduct = new \Magento\Framework\DataObject();
                try {
                    $this->dpoProduct = $this->_productRepository->getById((int)$this->dpoConfig['sku']);
                } catch (\Exception $e) { }
