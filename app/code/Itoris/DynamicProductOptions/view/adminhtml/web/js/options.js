    ...
    Itoris.OptionManager.prototype = {
        ...
        initialize : function(config, sections) {
            ...
            var block2 = jQuery('<div class="setting_block2">')
                ...
                .append(jQuery('.field-itoris-dynamicproductoptions-sku-order'))
                .append(jQuery('.field-itoris-dynamicproductoptions-weight'));
            jQuery(block1).after(block2);
            jQuery('#itoris-dynamicproductoptions-sku').change(function(){
                jQuery('.field-itoris-dynamicproductoptions-sku-order').css({display: this.value == 3 ? 'block' : 'none'});
            }).trigger('change');
        ...
        hidePopup : function(clearConfig) {
            if ($('toggledpo_abstract_wysiwyg')) $('toggledpo_abstract_wysiwyg').click();
        ...
        showTierPopup: function(row, config) {
            ...
            if (config.tier_price) {
                ...
                for(var i=0; i<tierPrice.length; i++) {
                    ...
                    tr.select('.dpo_tier_price')[0].value = parseFloat(tierPrice[i].price);
        ...
        showExtraPopup: function(row, config) {
            ...
            window.dpo_extra_popup.select('.dynamicoptions-value-special_price')[0].value = config.special_price ? (config.special_price - 0) : '';
        ...
        saveTierPrices: function(button) {
            ...
            tbody.select('tr').each(function(tr){
                ...
                tier.price = parseFloat(tr.select('.dpo_tier_price')[0].value);
