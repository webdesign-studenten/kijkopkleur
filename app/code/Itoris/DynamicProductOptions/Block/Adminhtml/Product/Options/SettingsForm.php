...
class SettingsForm extends \Magento\Backend\Block\Widget\Form\Generic
{
    protected function _prepareForm() {
        ...
        $configurationFieldset->addField('itoris-dynamicproductoptions-sku-order', 'text', [
            'label'  => $this->escapeHtml(__('SKU format')),
            'title'  => $this->escapeHtml(__('SKU format')),
            'name'   => 'itoris_dynamicproductoptions[sku_order]',
            'value' => $this->getOptionsConfig()->getSkuOrder(),
            'data-form-part' => 'product_form',
            'style' => 'width:400px',
            'placeholder' => 'Example: {base}-{F5}-{F1}-{F3}-etc'
        ]);
