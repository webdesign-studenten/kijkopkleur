...
use RLTSquare\ColorSwatch\Model\ColorSwatchFactory;
/**
 * Class Products
...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param ColorSwatchFactory $attachmentFactory
    ...
    public function __construct(
        ...
        ColorSwatchFactory $contactFactory,
    ...
    protected function _construct()
    {
        ...
        if ($this->getRequest()->getParam('colorswatch_id')) {
    ...
    {
        $contactId = $this->getRequest()->getParam('colorswatch_id');
