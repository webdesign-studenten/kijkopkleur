...
namespace Magenuts\Productattach\Controller\Adminhtml\Index;

use Magento\Backend\App\Action;
use Magenuts\Productattach\Helper\Data;
...
class Save extends \Magento\Backend\App\Action
{
     ...
     * @param \Magenuts\Productattach\Model\Productattach $attachModel
     * @param \Magento\Backend\Model\Session $backSession
     * @param \Magenuts\Productattach\Helper\Data $data
     */
    public function __construct(
        Action\Context $context,
        PostDataProcessor $dataProcessor,
        \Magenuts\Productattach\Model\Productattach $attachModel,
        Data $helper
    ) {
    ...
    {
        return $this->_authorization->isAllowed('Magenuts_Productattach::save');
    }
