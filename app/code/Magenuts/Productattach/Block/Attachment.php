...
namespace Magenuts\Productattach\Block;
...
class Attachment extends \Magento\Framework\View\Element\Template
{
     ...
     *
     * @var Magenuts\Productattach\Model\ResourceModel\Productattach\Collection
     */
     ...
     * @param \Magenuts\Productattach\Helper\Data $dataHelper
    ...
    public function __construct(
        ...
        \Magenuts\Productattach\Helper\Data $dataHelper,
     ...
     *
     * @return Magenuts\Productattach\Model\ResourceModel\Productattach\Collection
     */
    ...
    {
        if ($fileExt) {
            $iconImage = $this->getViewFileUrl('Magenuts_Productattach::images/'.$fileExt.'.png');
        } else {
            $iconImage = $this->getViewFileUrl('Magenuts_Productattach::images/unknown.png');
        }
        return $iconImage;
    }
    ...
    {
        $iconImage = $this->getViewFileUrl('Magenuts_Productattach::images/link.png');
        return $iconImage;
    }
