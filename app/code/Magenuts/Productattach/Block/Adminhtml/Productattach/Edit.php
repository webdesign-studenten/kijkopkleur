...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Magenuts_Productattach';
        $this->_controller = 'adminhtml_productattach';

        parent::_construct();

        if ($this->_isAllowedAction('Magenuts_Productattach::save')) {
        ...
        if ($this->_isAllowedAction('Magenuts_Productattach::productattach_delete')) {
